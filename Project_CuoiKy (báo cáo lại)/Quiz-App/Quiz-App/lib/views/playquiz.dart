...
class _QuizPlayState extends State<QuizPlay> {
  ...
  QuestionModel getQuestionModelFromDatasnapshot(
    ...
    questionModel.question = questionSnapshot["câu hỏi"];

    /// shuffling the options
    List<String> options = [
      questionSnapshot["lựa chọn 1"],
      questionSnapshot["lựa chọn 2"],
      questionSnapshot["lựa chọn 3"],
      questionSnapshot["lựa chọn 4"]
    ];
    options.shuffle();
    ...
    questionModel.correctOption = questionSnapshot["lựa chọn 1"];
